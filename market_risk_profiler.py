...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--api-key-id", default=os.getenv("KALSHI_API_KEY_ID", ""))
    parser.add_argument("--private-key", default=os.getenv("KALSHI_PRIVATE_KEY_PATH", "privkey.txt"))
