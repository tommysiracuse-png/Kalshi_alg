...
class TopOfBookBot:
    ...
    def handle_fill_update(self, fill_message: dict) -> None:
        ...
        if side == "yes":
            price_units = parse_optional_price_units(fill_message, "yes_price_dollars", "yes_price")
        else:
            ...
            price_units = parse_optional_price_units(fill_message, "no_price_dollars", "no_price")
            if price_units is None:
                yes_price_units = parse_optional_price_units(fill_message, "yes_price_dollars", "yes_price")
